...
<!--  
	Tomcat8.0부터는 EL에서 변수할당을 할 수 있다. 하지만 변수 할당과 동시에 출력되므로,
...
또한 자동형변환이 적용되므로 정수끼리의 연산에서 실수의 결과가 나올 수도 있다. -->
num3 / num4 : ${ num3 / num4 } <br />
num3 div num4 : ${ num3 div num4 } <br />
<!-- 나머지 연산을 위해 % 와 mod 연산자를 사용할 수 있다. -->
num3 % num4 : ${ num3 % num4 } <br />
...
num1 + "34" : ${ num1 + "34" } <br />
<!-- 하지만 숫자와 문자열 혹은 문자열과 문자열의 경우에는 연산불능이므로 예외 발생 -->

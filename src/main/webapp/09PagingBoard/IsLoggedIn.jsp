...
<%
/*
session 영역에 저장된 회원 인증 관련 속성값이 있는지 확인하여 만약 없다면
...
if (session.getAttribute("UserId") == null) {
	...
	*/
	...
	// 만약 아래에 JSP 코드가 있다면 위의 JS코드는 실행되지 않는다.
	// response.sendRedirect("List.jsp");
	
	/*
	JSP파일에서 return을 사용하는 것은 _jspService() 메소드의 실행을 종료하겠다는 의미를
	가지고 있다. 또한 Javascript보다 JSP코드의 실행이 우선순위가 높으므로
